...
// Tried in order: vignanam (all scripts) first, then sanskritdocuments as a
// Devanagari fallback for anything vignanam misses.
const SOURCES = [vignanam, sanskritdocuments];
